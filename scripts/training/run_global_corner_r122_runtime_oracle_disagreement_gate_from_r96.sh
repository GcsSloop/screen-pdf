...
OUTPUT_ROOT="${OUTPUT_ROOT:-training/runs/global_corner_r122_202604_runtime_oracle_disagreement_gate_from_r96_v1}"
...
python program/engine/global_corner_train.py \
  ...
  --teacher-guidance-weight 0.12 \
  --teacher-blend-ratio 0.25 \
  --teacher-corner-error-max 0.02 \
  --teacher-sample-error-max 0.015 \
  --teacher-target-mode oracle \
  --teacher-candidate-sources teacher,r3 \
  --teacher-opencv-score-min 0.2 \
  --teacher-activation-min-disagreement 0.01 \
  --inset-weight 1.2 \
