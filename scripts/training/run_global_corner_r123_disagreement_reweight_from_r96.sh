...
OUTPUT_ROOT="${OUTPUT_ROOT:-training/runs/global_corner_r123_202604_disagreement_reweight_from_r96_v1}"
...
python program/engine/global_corner_train.py \
  ...
  --sample-weight-power 0.15 \
  --disagreement-sample-weight-floor 0.01 \
  --disagreement-sample-weight-boost 1.6 \
  --geometry-priority-sample-weight-boost 1.2 \
